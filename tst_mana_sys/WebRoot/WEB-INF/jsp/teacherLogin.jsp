...
<!--选择不同的单选按钮登陆到不同界面的函数 -->
	function check() {
		...
		$.ajax({
			type: 'post',
			url: '<%=basePath %>/teacherLoginCheck.action',
...
<body class="bg-info">
	...
	<form name="form1" action="<%=basePath%>/teacher/teacherHome.action" method="post">
		...
		<div style="left: 1000px; top: 200px; position: absolute">
			<br> <input type="text" class="form-control" id="username"
				placeholder="教师编号" style="font-size: 20px; width: 250px">
			<br> <input type="password" class="form-control" id="password"
				...
				<br><br>
			<input type="button" value="教师登录" style="font-size: 20px; width: 250px"
